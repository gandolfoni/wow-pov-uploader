...
def compress_with_ffmpeg(input_path, output_path):
    ...
    try:
        ...
        logging.info(f"Compression completed successfully: {output_path}")
        return output_path
...
def upload_to_youtube(youtube, file_path, title, description="Raid Upload", playlist_id=None):
    ...
    try:
        ...
        if playlist_id:
            try:
                ...
                logging.error(f"Failed to add to playlist: {e}")
...
class VideoHandler(FileSystemEventHandler):
    ...
    def on_created(self, event):
        ...
        try:
            ...
            logging.error(f"Failed to process video {event.src_path}: {e}")
        finally:
    ...
    def _process_video(self, file_path):
        ...
        try:
            ...
            # Upload to YouTube
            video_url = upload_to_youtube(self.youtube, final_path, title=new_name, playlist_id=YOUTUBE_PLAYLIST_ID)
            ...
            logging.error(f"Processing failed, restoring backup: {e}")
...
if __name__ == "__main__":
    try:
        ...
        logging.info(f"Watching {WATCH_FOLDER} for new videos...")
